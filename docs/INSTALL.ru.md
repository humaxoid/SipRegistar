# Инструкция по установке — pfSense-pkg-SipRegistar v2.6.0
...
└── packages/
    ├── pfSense-pkg-SipRegistar-2.6.0.pkg   # сам пакет
...
- **System → Package Manager → Installed Packages** — появляется `SIP Registrar 2.6.0`.
