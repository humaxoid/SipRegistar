# Installation Guide — pfSense-pkg-SipRegistar v2.5.1
...
└── packages/
    ├── pfSense-pkg-SipRegistar-2.5.1.pkg   # the package
...
- **System → Package Manager → Installed Packages** — shows `SIP Registrar 2.5.1`.
